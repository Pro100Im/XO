...
public struct EntityNetworkConfiguration
{
...
/// </remarks>
public class EntityDriverConstructor : INetworkStreamDriverConstructor
{
    ...
    public static NetworkSettings GameNetworkSettings(int sendQueueCapacity, int receiveQueueCapacity)
    {
